//
//  AMFetchingTableViewController.m
//  41CoreData
//
...
@interface AMFetchingTableViewController ()

@end

@implementation AMFetchingTableViewController

- (void) viewDidLoad {
    
    [super viewDidLoad];
    self.managedObjectContext = [AMDataManager sharedManager].persistentContainer.viewContext;
