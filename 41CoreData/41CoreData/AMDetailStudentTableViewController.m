//
//  AMDetailStudentTableViewController.m
//  41CoreData
//
...
@interface AMDetailStudentTableViewController () <UITextFieldDelegate>
...
@implementation AMDetailStudentTableViewController
...
- (void) addSettingForTextField:(UITextField*)textField withFormat:(AMFormatTextField)format {
    
    if (format == AMFormatTextFieldName) {
    ...
    } else if (format == AMFormatTextFieldEmail) {
...
- (void) actionSave:(UIBarButtonItem*)sender {
    ...
    if (!self.student) {
        ...
        self.student = [[AMStudent alloc] initWithContext:context];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        AMDetailStudentTableViewCell* cell = [tableView dequeueReusableCellWithIdentifier:@"AMDetailStudentTableViewCell" forIndexPath:indexPath];
        ...
        switch (indexPath.row) {
            ...
            case 2:
                ...
                cell.formatTextField = AMFormatTextFieldEmail;
                [self addSettingForTextField:cell.textField withFormat:cell.formatTextField];
                if (self.student) {
        ...
        if ([self.courses count] > 0) {
            ...
            AMCourse* course = [self.courses objectAtIndex:indexPath.row];
            cell.textLabel.text = course.name;
            
        } else {
            
            AMCourse* course = [self.teacher objectAtIndex:indexPath.row];
            cell.textLabel.text = course.name;
